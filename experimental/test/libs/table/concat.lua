...
--- table.concat error when including holes
-- table.concat must throw an error (invalid value at index 2) when explicitly
-- including a nil
do
...
--- table.concat on contiguous arrays
-- table.concat mustn't throw an error when it is called on contiguous arrays,
-- even if the values are in the hash part of the table.
